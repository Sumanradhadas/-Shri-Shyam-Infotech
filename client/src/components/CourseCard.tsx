    ...
    >
      ...
      <CardContent className="space-y-4 flex-1 flex flex-col">
        <div className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <span>{course.duration} {typeof course.duration === 'string' ? '' : 'months'}</span>
          ...
          <DialogContent className="max-w-2xl" data-testid={`dialog-course-${course.id}`}>
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <Badge variant="outline">
                      ...
                      {course.duration} {typeof course.duration === 'string' ? '' : 'months'}
                    </Badge>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-6 space-y-4">
              <div className="bg-muted p-4 rounded-md">
                <h4 className="font-semibold mb-2 text-foreground">Program Highlights</h4>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>✓ Industry-recognized certification</li>
                  <li>✓ Hands-on practical training (70% practical, 30% theory)</li>
                  <li>✓ Expert instructors with 5+ years industry experience</li>
                  <li>✓ 98% placement assistance after completion</li>
              ...
              <div className="flex gap-3 flex-wrap">
                ...
                >
                  <a href="tel:+916287875040">Enroll Now</a>
                </Button>
                <Button 
                  variant="outline" 
                  className="flex-1"
