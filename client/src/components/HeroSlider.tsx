        ...
        >
          ...
          <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-white px-6 text-center">
            <motion.h1
              ...
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 max-w-4xl leading-tight"
            >
            ...
            <motion.p
              ...
              className="text-base sm:text-lg md:text-xl mb-6 md:mb-8 max-w-3xl leading-relaxed"
            >
